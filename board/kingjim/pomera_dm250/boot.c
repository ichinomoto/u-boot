...
static const struct dm250_layout recovery_layout = {
...
static int do_dm250boot(struct cmd_tbl *cmdtp, int flag, int argc,
			char *const argv[])
{
...
U_BOOT_CMD(dm250boot, 2, 0, do_dm250boot,
	   "boot DM250 directly from SD or chainload legacy eMMC U-Boot",
	   "[sd|emmc|recovery]\n"
